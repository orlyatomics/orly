...
TExpr::TPtr TTake::New(const TExpr::TPtr &lhs, const TExpr::TPtr &rhs, const TPosRange &pos_range) {
  return TTake::TPtr(new TTake(lhs, rhs, pos_range));
}

TTake::TTake(const TExpr::TPtr &lhs, const TExpr::TPtr &rhs, const TPosRange &pos_range)
