...
namespace Orly {
  ...
  namespace Expr {
    ...
    class TToLower
      ...
      typedef std::shared_ptr<TToLower> TPtr;
      ...
      TToLower(const TExpr::TPtr &expr, const TPosRange &pos_range);
    ...
    class TToUpper
      ...
      typedef std::shared_ptr<TToUpper> TPtr;
      ...
      TToUpper(const TExpr::TPtr &expr, const TPosRange &pos_range);
