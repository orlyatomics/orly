...
namespace Orly {
  ...
  namespace Expr {
    ...
    class TThat
      ...
      typedef std::shared_ptr<TThat> TPtr;

      static TPtr New(const TThatable::TPtr &thatable, const TPosRange &pos_range);
      ...
      TThat(const TThatable *thatable, const TPosRange &pos_range);

      const TThatable *Thatable;
