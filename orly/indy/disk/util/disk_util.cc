...
void TDiskUtil::CreateVolume(const std::string &instance_name,
  ...
  const size_t num_logical_per_orly_physical = Util::PhysicalBlockSize / logical_block_size;
  /* take off 1 for the super block */
  min_logical_blocks = ((min_logical_blocks / num_logical_per_orly_physical) - 1) * num_logical_per_orly_physical;
