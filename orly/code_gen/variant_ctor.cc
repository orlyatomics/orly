/* <orly/code_gen/variant_ctor.cc>

   Implements <orly/code_gen/variant_ctor.h>.
...
TVariantCtor::TVariantCtor(const L0::TPackage *package,
                           const Type::TType &type,
                           const std::string &tag,
                           const TInline::TPtr &payload)
    : TInline(package, type), Tag(tag), Payload(payload) {}
