/* <orly/code_gen/builder.cc>

   Implements <orly/code_gen/builder.h>
...
#include <orly/code_gen/collated_by.h>
#include <orly/code_gen/collected_by.h>
...
TInline::TPtr Orly::CodeGen::Build(const L0::TPackage *package, const Expr::TExpr::TPtr &expr, bool keep_mutable, bool keep_sequence) {
  ...
  class TVisitor : public Expr::TExpr::TVisitor {
    ...
    /* NOTES:
        ...
        We taker ret_type because we may have unwrapped the sequence which means that the return type of the orly expr
            is a lie. */
