/* <orly/rt/time_pnt_obj.h>

   The `TObj` record returned by orly's `TimePnt` builtin --
   `{day, hour, minute, month, nanosecond, second, utc_offset, year}`.
   Same pattern as `time_diff_obj.h`: mostly auto-generated by orlyc,
   checked in so code-gen has the type available pre-package-load,
   with one hand-edited constructor that builds from
   `Base::Chrono::TTimePntInfo`.
...
/* This file was auto-generated by the Orly compiler.

   We are using it because we needed to produce an object for TimePnt code-gen that was
   basically what Orly would code-gen for itself.  */
  ...
  namespace Type {
    ...
    struct TDt<Rt::Objects::TObjO8i3dayi4houri6minutei5monthi10nanosecondi6secondi10utc_offseti4year> {
      ...
      static TType GetType() {
        return TObj::Get({{"day", Orly::Type::TInt::Get()}, {"hour", Orly::Type::TInt::Get()}, {"minute", Orly::Type::TInt::Get()}, {"month", Orly::Type::TInt::Get()}, {"nanosecond", Orly::Type::TInt::Get()}, {"second", Orly::Type::TInt::Get()}, {"utc_offset", Orly::Type::TInt::Get()}, {"year", Orly::Type::TInt::Get()}});
      }
...
namespace std {
  template<>
  struct hash<Orly::Rt::Objects::TObjO8i3dayi4houri6minutei5monthi10nanosecondi6secondi10utc_offseti4year> {

    typedef size_t return_type;
    typedef Orly::Rt::Objects::TObjO8i3dayi4houri6minutei5monthi10nanosecondi6secondi10utc_offseti4year argument_type;

    size_t operator()(const argument_type &obj) const {
      return  obj.GetHash();
    }

  }; // hash<Orly::Rt::Objects::TObjO8i3dayi4houri6minutei5monthi10nanosecondi6secondi10utc_offseti4year>
} // std